...
TIP: Si se inicia la operación de creación de clúster, pero no se puede completar, es posible que la contraseña de administrador de ONTAP que defina no se aplique. Si esto sucede, comuníquese con el soporte técnico de NetApp para obtener ayuda.
